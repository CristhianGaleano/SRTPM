...
<body>
    <div id="bar">
        ...
        <ul>
            ...
            <li style="padding-left: 190px;"><a href=" <?php URL?>formulario_permisoH_extendido.php" target="_blank"><img src="img/horario-extendido.png" alt="amco" height="75" ></a></li>
            <li style="padding-left: 20px;"><a href=" <?php URL?>formulario_permiso_parrillero1.php" target="_blank"><img src="img/permiso-parrrillero.png" alt="amco" height="75"></a></li>
        </ul>       
        </div>
        <div id="container">
            <!-- Login Starts Here -->
